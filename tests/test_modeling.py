...
class TestTrainModel:
    ...
    def test_train_model_basic(self, sample_documents):
        ...
        trained_model, history = modeling.train_model(
            model=model, documents=sample_documents, iterations=10, train_parameters={}
        )
    ...
    def test_train_model_single_document(self):
        ...
        trained_model, history = modeling.train_model(
            model=model, documents=single_doc, iterations=5, train_parameters={}
        )
        assert trained_model is not None
...
class TestCreateMotifSpectra:
    ...
    def test_create_motif_spectra_with_metadata(self, sample_motif_features):
        ...
        spectra = modeling.create_motif_spectra(
            sample_motif_features, charge=2, motifset_name="test_motifs"
        )
    ...
    def test_create_motif_spectra_significant_digits(self, sig_digits):
        ...
        spectra = modeling.create_motif_spectra(features, significant_digits=sig_digits)
        assert spectra[0].peaks.mz[0] == pytest.approx(round(123.456789, sig_digits))
