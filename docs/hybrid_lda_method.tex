...
If a discovery progress callback finalizes the just-completed epoch, the outer
discovery loop detects the one-way state transition and stops before another
topic update.
