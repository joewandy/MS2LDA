...
Clean-room orchestration & \texttt{reproduction\_plan.py}; \texttt{run\_contextual\_sparse\_etm\_reproduction.py} \\
Evidence verification and packaging & \texttt{reproduction\_audit.py}; \texttt{package\_contextual\_sparse\_etm\_reproduction.py} \\
\bottomrule
