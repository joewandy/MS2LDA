...
remained \MedianEffectiveTopics{}, and \StabilityUniqueRange{} topics became the
largest component for at least one test spectrum. These results support
...
iterations; validation and test inference use 100 iterations and parallel scheme 1.
...
\midrule
\input{generated/routing_etm_test_table.tex}
\end{tabular}
\end{table}
...
\StabilityNLLRange{}. Across the runs,
...
The NLL and sparsity ranges test whether the mechanism is specific to one
initialization. Chemical scores vary more than predictive fit across seeds.
This pattern is consistent with a breadth--quality trade-off and motivates
reporting motif counts together with the SOS distribution rather than reducing
performance to one average.
