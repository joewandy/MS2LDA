...
$\alpha=0.6$, $\eta=0.1$, \TomotopyWorkers{} workers and parallel scheme
\TomotopyParallelScheme{}. It trains until convergence or
\TomotopyMaximumIterations{} iterations, ending at
\TomotopyTrainingIterations{} iterations in this run; validation and test
inference use \TomotopyInferenceIterations{} iterations and parallel scheme 1.
...
\HighKEntmaxMedianSupport{} but uses only \HighKEntmaxUniqueTopOne{} of the 18
planted motifs as winners. Contextual Sparse ETM keeps median exact support
\HighKContextualMedianSupport{}, recovers \HighKContextualUniqueTopOne{} planted
motifs as distinct winners, achieves beta/theta recovery
