...
Scientific calculations and claim checks live in reproduction_comparison and
reproduction_summaries. This module contains only the mechanical boundary: copy
the selected
