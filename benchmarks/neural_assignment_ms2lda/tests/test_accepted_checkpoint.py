...
from benchmarks.neural_assignment_ms2lda.data import sparse_batch
from benchmarks.neural_assignment_ms2lda.utils import file_sha256, read_json
...
def test_accepted_paper_results_are_fixed() -> None:
    ...
    assert methods["neural"]["validation"] == {
        ...
        "completion_nll_per_token": 8.501446912771746,
